...
export  const CarouselSlide = ({ slide, type }: {
    slide: any,
    ...
    const ImageContent = () => (
        <>
            <img
                src={type === 'featured' ? slide.slider_image.paths.blur : slide.media.paths.blur}
                alt="blur"
            ...
            <img
                src={type === 'featured' ? slide.slider_image.paths.original : slide.media.paths.original}
                alt={type === 'featured' ? slide.translations.id.title : slide.media.file_name}
